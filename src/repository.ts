...
import { IExperiment, CustomHeaders, CustomHeadersFunction } from './interfaces';
...
export default class Repository extends EventEmitter implements EventEmitter {
    ...
    validateFeature(feature: IExperiment) {
        const errors: string[] = [];
            ...
            (error: Error | null, res: Response, body: string) => {
                ...
                try {
                    ...
                    const obj = data.features.reduce(
                        (o: { [s: string]: IExperiment }, feature: IExperiment) => {
                            this.validateFeature(feature);
                            o[feature.name] = feature;
                            return o;
                        },
                        {} as { [s: string]: IExperiment },
                    );
